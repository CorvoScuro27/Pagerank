...
#define DEFAULT_K 3      // Nodi da mostrare
#define DEFAULT_M 100    // Numero max iterazioni
#define DEFAULT_D 0.9    // Damping factor
#define DEFAULT_E 1.0e-7 // Tolleranza
#define DEFAULT_T 3      // Numero thread ausiliari
...
// mutex
int xpthread_mutex_init(pthread_mutex_t *restrict_mutex, const pthread_mutexattr_t *restrict_attr, int linea, char *file);
...
// condition variables
int xpthread_cond_init(pthread_cond_t *restrict_cond, const pthread_condattr_t *restrict_attr, int linea, char *file);
int xpthread_cond_destroy(pthread_cond_t *cond, int linea, char *file);
int xpthread_cond_wait(pthread_cond_t *restrict_cond, pthread_mutex_t *restrict_mutex, int linea, char *file);
